...
def L_layer_model(X, Y, parameters, learning_rate = 0.0075):#lr was 0.009
    """
...
def train(X, y,parameters, mini_batch_size=32, epochs = 20, learning_rate = 0.2 ):
    ...
    for i in range(epochs):
        ...
        for mini_batch in mini_batches:
            ...
            parameters, cost = L_layer_model(X_mini.T, y_mini.T, parameters, learning_rate )
            cost_per_epoch += cost
